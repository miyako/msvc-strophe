...
tls_t *tls_new(xmpp_conn_t *conn)
{
    ...
    ret = tls->sft->AcquireCredentialsHandleW(NULL, UNISP_NAME,
...
int tls_start(tls_t *tls)
{
    ...
    ret = tls->sft->InitializeSecurityContextW(&(tls->hcred), NULL, name, ctxtreq, 0, 0,
	...
	ret = tls->sft->InitializeSecurityContextW(&(tls->hcred), &(tls->hctxt), name,
					      ctxtreq, 0, 0, &sbdin, 0,
					      &(tls->hctxt), &sbdout,
					      &ctxtattr, NULL);
    }
